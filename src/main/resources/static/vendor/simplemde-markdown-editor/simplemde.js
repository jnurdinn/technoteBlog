			...
			1: [
				function (e, t, n) {
					...
					function l(e) {
						...
						return (
							1 === r ? ((t = e[n - 1]), (i += s[t >> 2]), (i += s[(t << 4) & 63]), (i += "==")) : 2 === r && ((t = (e[n - 2] << 8) + e[n - 1]), (i += s[t >> 10]), (i += s[(t >> 4) & 63]), (i += s[(t << 2) & 63]), (i += "=")),
							o.push(i),
							o.join("")
						);
					}
					...
					(function (t) {
									...
									switch (l) {
										...
										case 4:
											(s = e[i + 1]),
												(c = e[i + 2]),
												(u = e[i + 3]),
												128 === (192 & s) && 128 === (192 & c) && 128 === (192 & u) && ((f = ((15 & o) << 18) | ((63 & s) << 12) | ((63 & c) << 6) | (63 & u)), f > 65535 && 1114112 > f && (a = f));
									}
								}
						...
						(n.Buffer = a),
							...
							(a.prototype.compare = function (e, t, n, r, i) {
								if (!a.isBuffer(e)) throw new TypeError("Argument must be a Buffer");
								if ((void 0 === t && (t = 0), void 0 === n && (n = e ? e.length : 0), void 0 === r && (r = 0), void 0 === i && (i = this.length), 0 > t || n > e.length || 0 > r || i > this.length))
				...
				function (t, n, r) {
					!(function (i) {
						...
						e.defineOption("styleSelectedText", !1, function (r, a, l) {
							var s = l && l != e.Init;
							a && !s
								? ((r.state.markedSelection = []), (r.state.markedSelectionStyle = "string" == typeof a ? a : "CodeMirror-selectedtext"), o(r), r.on("cursorActivity", t), r.on("change", n))
			...
			10: [
				function (t, n, r) {
					!(function (t) {
						...
						function i(e) {
							e.options.lineWrapping ? (Ja(e.display.wrapper, "CodeMirror-wrap"), (e.display.sizer.style.minWidth = ""), (e.display.sizerWidth = null)) : (Za(e.display.wrapper, "CodeMirror-wrap"), h(e)),
								a(e),
								Dt(e),
								lt(e),
								setTimeout(function () {
						...
						function H(e) {
							return (
								e.node == e.text &&
								((e.node = ji("div", null, null, "position: relative")), e.text.parentNode && e.text.parentNode.replaceChild(e.node, e.text), e.node.appendChild(e.text), xo && 8 > bo && (e.node.style.zIndex = 2)),
								e.node
							);
						}
						function W(e) {
								...
								if (
									(e.display.input.setUneditable(a),
										...
										(t.lineNumber = a.appendChild(
											ji("div", S(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px")
										)),
										o)
								)
								...
								for (var a = 0; a < o.markedSpans.length; ++a) {
									...
									if ((null == l.from || (s.inclusiveLeft ? l.from <= t.ch : l.from < t.ch)) && (null == l.to || (s.inclusiveRight ? l.to >= t.ch : l.to > t.ch))) {
										...
										if (n) {
											var c,
												u = s.find(0 > r ? 1 : -1);
											if (((0 > r ? s.inclusiveRight : s.inclusiveLeft) && (u = Pe(e, u, -r, u && u.line == t.line ? o : null)), u && u.line == t.line && (c = _o(u, n)) && (0 > r ? 0 > c : c > 0)))
												return Oe(e, u, t, r, i);
										}
						...
						function tt(e, t, n, r, i) {
							...
							return (
								t.cache.hasOwnProperty(a)
									? (o = t.cache[a])
									: (t.rect || (t.rect = t.view.text.getBoundingClientRect()), t.hasHeights || (Ke(e, t.view, t.rect), (t.hasHeights = !0)), (o = rt(e, t, n, r)), o.bogus || (t.cache[a] = o)),
						...
						function Mt(e) {
							...
							null != e.adjustWidthTo &&
								((t.display.sizer.style.minWidth = e.adjustWidthTo + "px"), e.maxScrollLeft < t.doc.scrollLeft && on(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0), (t.display.maxLineChanged = !1));
						...
						function Nt(e) {
							...
							if (
								(e.updatedDisplay && N(t, e.update),
									...
									((r.scrollTop = Math.max(0, Math.min(n.scroller.scrollHeight - n.scroller.clientHeight, e.scrollTop))), n.scrollbars.setScrollTop(r.scrollTop), (n.scroller.scrollTop = r.scrollTop)),
									null == e.scrollLeft ||
									(n.scroller.scrollLeft == e.scrollLeft && !e.forceScroll) ||
									((r.scrollLeft = Math.max(0, Math.min(n.scroller.scrollWidth - n.scroller.clientWidth, e.scrollLeft))), n.scrollbars.setScrollLeft(r.scrollLeft), (n.scroller.scrollLeft = r.scrollLeft), w(t)),
									e.scrollToPos)
							) {
						...
						function Vt(e, t, n) {
							...
							e.options.dragDrop && el && !e.isReadOnly() && "single" == r && (o = a.contains(n)) > -1 && (_o((o = a.ranges[o]).from(), n) < 0 || n.xRel > 0) && (_o(o.to(), n) > 0 || n.xRel < 0)
								? Kt(e, t, n, l)
								: Xt(e, t, n, r, l);
						}
						function Kt(e, t, n, r) {
						...
						function Xt(e, t, n, r, i) {
							...
							var u,
								...
								h = c.sel,
								d = h.ranges;
							if ((i && !t.shiftKey ? ((f = c.sel.contains(n)), (u = f > -1 ? d[f] : new fe(n, n))) : ((u = c.sel.primary()), (f = c.sel.primIndex)), Oo ? t.shiftKey && t.metaKey : t.altKey))
						...
						function tn(e, t) {
							...
							if (n) {
								...
								He(e, n, r),
									e.display.dragCursor || ((e.display.dragCursor = ji("div", null, "CodeMirror-cursors CodeMirror-dragcursors")), e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)),
						...
						function rn(e, t) {
							Math.abs(e.doc.scrollTop - t) < 2 ||
								((e.doc.scrollTop = t), go || A(e, { top: t }), e.display.scroller.scrollTop != t && (e.display.scroller.scrollTop = t), e.display.scrollbars.setScrollTop(t), go && A(e), _e(e, 100));
						}
						function on(e, t, n) {
							...
							if (a)
								for (var l = 0; l < a.length; ++l) {
									...
									if (s.marker.collapsed) {
										...
										if (
											!((u >= 0 && 0 >= f) || (0 >= u && f >= 0)) &&
											((0 >= u && (s.marker.inclusiveRight && i.inclusiveLeft ? _o(c.to, n) >= 0 : _o(c.to, n) > 0)) || (u >= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? _o(c.from, r) <= 0 : _o(c.from, r) < 0)))
										)
											return !0;
									}
								}
						...
						function Br(e, t) {
							...
							for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
								...
								qr(a, r, Dr(e, a, l)),
									a.styleClasses && (a.styleClasses.bgClass && (r.bgClass = $i(a.styleClasses.bgClass, r.bgClass || "")), a.styleClasses.textClass && (r.textClass = $i(a.styleClasses.textClass, r.textClass || ""))),
						...
						function ci(e, t, n, r) {
							...
							var o,
								a = +new Date();
							if (
								(i.lastOp == r || (i.lastOrigin == t.origin && t.origin && (("+" == t.origin.charAt(0) && e.cm && i.lastModTime > a - e.cm.options.historyEventDelay) || "*" == t.origin.charAt(0)))) &&
								(o = si(i, i.lastOp == r))
							) {
								var l = Ii(o.changes);
								...
								var s = Ii(i.done);
								for ((s && s.ranges) || hi(e.sel, i.done), o = { changes: [ai(e, t)], generation: i.generation }, i.done.push(o); i.done.length > i.undoDepth;) i.done.shift(), i.done[0].ranges || i.done.shift();
							}
							...
							for (var r = 0, i = []; r < e.length; ++r) {
								...
								if (o.ranges) i.push(n ? ue.prototype.deepCopy.call(o) : o);
									...
									for (var s = 0; s < a.length; ++s) {
										var c,
											u = a[s];
										if ((l.push({ from: u.from, to: u.to, text: u.text }), t)) for (var f in u) (c = f.match(/^spans_(\d+)$/)) && Pi(t, Number(c[1])) > -1 && ((Ii(l)[f] = u[f]), delete u[f]);
									}
								}
							}
							return i;
									...
									return (
										At(e, function () {
											Z(e, r.slice(o), n.length - o, null, l.composing ? "*compose" : null),
												...
												l.composing && (l.composing.range.clear(), (l.composing.range = e.markText(l.composing.start, e.getCursor("to"), { className: "CodeMirror-composing" })));
										}),
										!0
									);
								},
						...
						(e.prototype = {
							...
							refresh: Ot(function () {
								...
								Dt(this), (this.curOp.forceUpdate = !0), lt(this), this.scrollTo(this.doc.scrollLeft, this.doc.scrollTop), u(this), (null == e || Math.abs(e - yt(this.display)) > 0.5) && a(this), Pa(this, "refresh", this);
							}),
						...
						ma.prototype = {
							...
							column: function () {
								return (
									this.lastColumnPos < this.start && ((this.lastColumnValue = Fa(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue)), (this.lastColumnPos = this.start)),
						...
						e.defineMode(
							...
							function (t, n) {
								...
								function h(e) {
									...
									if (
										(e.linkHref ? t.push(S.linkHref, "url") : (e.strong && t.push(S.strong), e.em && t.push(S.em), e.strikethrough && t.push(S.strikethrough), e.linkText && t.push(S.linkText), e.code && t.push(S.code)),
											e.header && t.push(S.header, S.header + "-" + e.header),
											e.quote && (t.push(S.quote), !n.maxBlockquoteDepth || n.maxBlockquoteDepth >= e.quote ? t.push(S.quote + "-" + e.quote) : t.push(S.quote + "-" + n.maxBlockquoteDepth)),
											e.list !== !1)
									) {
				...
				function (t, n, r) {
					(function (t) {
						(function () {
							...
							function i(e, t) {
								if (((this.options = t || h.defaults), (this.links = e), (this.rules = p.normal), (this.renderer = this.options.renderer || new o()), (this.renderer.options = this.options), !this.links))
								...
								(t.prototype.token = function (e, t, n) {
									for (var r, i, o, a, l, s, c, u, f, e = e.replace(/^ +$/gm, ""); e;)
										if (((o = this.rules.newline.exec(e)) && ((e = e.substring(o[0].length)), o[0].length > 1 && this.tokens.push({ type: "space" })), (o = this.rules.code.exec(e))))
											...
											(e = e.substring(o[0].length)), this.tokens.push({ type: "blockquote_start" }), (o = o[0].replace(/^ *> ?/gm, "")), this.token(o, t, !0), this.tokens.push({ type: "blockquote_end" });
											...
											for (e = e.substring(o[0].length), a = o[2], this.tokens.push({ type: "list_start", ordered: a.length > 1 }), o = o[0].match(this.rules.item), r = !1, f = o.length, u = 0; f > u; u++)
												(s = o[u]),
													...
													this.options.smartLists && u !== f - 1 && ((l = d.bullet.exec(o[u + 1])[0]), a === l || (a.length > 1 && l.length > 1) || ((e = o.slice(u + 1).join("\n") + e), (u = f - 1))),
													(i = r || /\n\n(?!\s*$)/.test(s)),
							...
							(p._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/),
								...
								(p.normal = f({}, p)),
								(p.pedantic = f({}, p.normal, { strong: /^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/, em: /^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/ })),
								(p.gfm = f({}, p.normal, { escape: c(p.escape)("])", "~|])")(), url: /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, del: /^~~(?=\S)([\s\S]*?\S)~~/, text: c(p.text)("]|", "~]|")("|", "|https?://|")() })),
									...
									for (var t, n, r, i, o = ""; e;)
										if ((i = this.rules.escape.exec(e))) (e = e.substring(i[0].length)), (o += i[1]);
											...
											(e = e.substring(i[0].length)),
												"@" === i[2] ? ((n = ":" === i[1].charAt(6) ? this.mangle(i[1].substring(7)) : this.mangle(i[1])), (r = this.mangle("mailto:") + n)) : ((n = l(i[1])), (r = n)),
						...
						var i = function (e, t, n, i) {
							if (
								...
								if (((this.dictionary = e), "undefined" != typeof window && "chrome" in window && "extension" in window.chrome && "getURL" in window.chrome.extension))
									t || (t = this._readFile(chrome.extension.getURL("lib/typo/dictionaries/" + e + "/" + e + ".aff"))), n || (n = this._readFile(chrome.extension.getURL("lib/typo/dictionaries/" + e + "/" + e + ".dic")));
								else {
				...
				function (e, t, n) {
						...
						if ("single" === p) {
							...
							if (u.line !== f.line || u.ch !== f.ch) {
								...
								t(c.getLineHandle(u.line)) ? ((v = ""), (y = u.line)) : t(c.getLineHandle(u.line - 1)) ? ((v = ""), (y = u.line - 1)) : ((v = k + "\n"), (y = u.line)),
									t(c.getLineHandle(f.line)) ? ((x = ""), (b = f.line), 0 === f.ch && (b += 1)) : 0 !== f.ch && t(c.getLineHandle(f.line + 1)) ? ((x = ""), (b = f.line + 1)) : ((x = k + "\n"), (b = f.line + 1)),
									0 === f.ch && (b -= 1),
					...
					function N(e) {
						...
						/editor-preview-active-side/.test(r.className)
							? ((r.className = r.className.replace(/\s*editor-preview-active-side\s*/g, "")), (i.className = i.className.replace(/\s*active\s*/g, "")), (n.className = n.className.replace(/\s*CodeMirror-sided\s*/g, " ")))
							: (setTimeout(function () {
					...
					function D(e, t) {
						for (var n in t)
							t.hasOwnProperty(n) &&
								(t[n] instanceof Array ? (e[n] = t[n].concat(e[n] instanceof Array ? e[n] : [])) : null !== t[n] && "object" == typeof t[n] && t[n].constructor === Object ? (e[n] = D(e[n] || {}, t[n])) : (e[n] = t[n]));
						return e;
					}
					function H(e) {
					...
					function B(e) {
						...
						if (void 0 === e.toolbar) {
							...
							for (var o in K)
								K.hasOwnProperty(o) &&
									(-1 != o.indexOf("separator-") && e.toolbar.push("|"), (K[o]["default"] === !0 || (e.showIcons && e.showIcons.constructor === Array && -1 != e.showIcons.indexOf(o))) && e.toolbar.push(o));
						}
					...
					var z = e("codemirror-spell-checker"),
						...
						K = {
							...
							upload: { name: "upload", action: "/uploads/new", className: "fa fa-upload", title: "Upload Image", default: true},
							...
							guide: { name: "guide", action: "/markdown-guide", className: "fa fa-question-circle", title: "Markdown Guide", default: !0 },
					...
					(B.prototype.markdown = function (e) {
						...
						(B.prototype.toTextArea = function () {
							var e = this.codemirror,
								t = e.getWrapperElement();
							t.parentNode &&
								(this.gui.toolbar && t.parentNode.removeChild(this.gui.toolbar), this.gui.statusbar && t.parentNode.removeChild(this.gui.statusbar), this.gui.sideBySide && t.parentNode.removeChild(this.gui.sideBySide)),
								e.toTextArea(),
